	...
	return (
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<div class="col-12">
                ...
                <div class="col-12">
					<label for="inputCategory" class="form-label">CatageoryId</label>
					<input type="text" class="form-control" id="inputSalary" placeholder="Enter Category" autoComplete='off'
					onChange={e => setData({...data, salary: e.target.value})}/>
				</div>
				<div class="col-12">
