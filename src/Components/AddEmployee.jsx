...
function AddEmployee() {
	...
	const handleSubmit = (event) => {
		...
		axios.post('https://localhost:7036/api/Employee', formdata)
			.then(res => {
				if (res.data.Status) {
				navigate('/employee')
			}
	...
	return (
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<div className="col-12">
                ...
                <div className="col-12">
					<label htmlFor="inputCategory" className="form-label">CatageoryId</label>
					<input type="number" className="form-control" id="inputSalary" placeholder="Enter Category" autoComplete='off'
